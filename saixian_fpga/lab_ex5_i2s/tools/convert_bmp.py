...
def main() -> int:
    ap = argparse.ArgumentParser(description="转换为 1280x720、24 位、非压缩 BMP")
    ap.add_argument("source", type=Path)
    ap.add_argument("output", type=Path)
    ap.add_argument("--fit", choices=("crop", "contain"), default="contain")
    ...
    with Image.open(args.source) as im:
        ...
        if args.fit == "crop":
            ...
            canvas = Image.new("RGB", (1280, 720), args.background)
